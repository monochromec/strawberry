...
bool Song::is_stream() const { return is_radio() || d->source_ == Source::Subsonic || d->source_ == Source::Tidal || d->source_ == Source::Spotify || d->source_ == Source::Qobuz; }
...
bool Song::stream_url_can_expire() const { return d->source_ == Source::Tidal || d->source_ == Source::Spotify || d->source_ == Source::Qobuz; }
bool Song::is_module_music() const { return d->filetype_ == Song::FileType::MOD || d->filetype_ == Song::FileType::S3M || d->filetype_ == Song::FileType::XM || d->filetype_ == Song::FileType::IT; }
